    ...
    return (
        <div className="flex flex-col gap-4 px-6 md:px-0">
            ...
            <div className="flex flex-row gap-2 md:gap-4">
                <select
                    className={`${themes === "dark" ? "bg-[#212121]" : "bg-[#F7F8F3] [box-shadow:-2px_2px_6px_rgba(0,0,0,0.2)]"}  w-48 transition duration-200 flex flex-row items-center gap-2 md:gap-4 text-[0.85rem] md:text-[1rem] rounded-md px-2 md:px-4 py-1 md:py-2`}
                >
