        ...
        <div className="flex flex-col gap-15">
            ...
            <ul className="grid grid-cols-3 gap-6 w-[65vw]">
                ...
                >
                    ...
                    <span
                        className={`${themes === "dark" ? "bg-[#373737]" : "bg-[#f5f5f5] [box-shadow:-1px_1px_3px_rgba(0,0,0,0.2)]"} transition duration-200 flex ml-5 mt-10 flex-row gap-2 items-center justify-center px-2 py-1 w-[4rem]  rounded-sm`}
                    >
                        <Plus size={20} />
                        <p className="text-[0.9rem]">982</p>
                    </span>
                ...
                <li
                    className={`${themes === "dark" ? "bg-[#1C1D1E] " : "bg-[#f5f5f5] [box-shadow:-2px_2px_6px_rgba(0,0,0,0.2)]"} transition duration-200 w-[23rem] h-[25rem] rounded-2xl  overflow-hidden`}
                >
                    <img
                        src="/images/viktor.jpg"
                        alt="viktor"
